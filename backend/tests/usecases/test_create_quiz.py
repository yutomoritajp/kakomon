...
@pytest.mark.parametrize(
    ...
    ids=[
        "When R7-AM1 is selected, it should return the expected correct_options.",
        "When R6-AM1 is selected, it should return the expected correct_options.",
    ],
)
def test_get_correct_options(
    period: Period, section: Section, expected: dict[int, str]
):
    """
