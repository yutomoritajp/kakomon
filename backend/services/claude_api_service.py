...
class ClaudeApiService:
    ...
    def create_parse_message[T](
        self, messages: list, output_format: type[T], **kwargs
    ) -> types.ParsedMessage[T]:
        """
        ...
        logger.info(
            "ClaudeAPIリクエスト開始 model=%s, max_tokens=%s",
            self._model,
            self._max_tokens,
        )
        ...
        logger.info(
            "ClaudeAPIリクエスト終了 stop_reason=%s, usage=%s",
